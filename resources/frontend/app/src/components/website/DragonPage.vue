        ...
        <td style="text-align:center">
          ...
          <table width=100%>
            <tr>
              <td colspan='3'>
                <p>
                  <img src="../../assets/images/dragon-small.png" style="float:left;height:200px" alt="Golden Dragon">
                  <img src="../../assets/images/dragon-small-flipped.png" style="float:right;height:200px"
                       alt="Golden Dragon">
